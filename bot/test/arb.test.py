...
reserves = list(map(np.array, [
    ...
    [10, 5], # uniswapV2 TOKEN-0/TOKEN-1 (10 TOKEN-0 & 1 TOKEN-1 IN POOL)
    [1, 10], # uniswapV2 TOKEN-1/TOKEN-2 (1 TOKEN-1 & 5 TOKEN-2 IN POOL)
    [10, 50], # uniswapV2 TOKEN-2/TOKEN-3  (40 TOKEN-2 & 50 TOKEN-3 IN POOL)
    [20, 40], # uniswapV2 TOKEN-2/TOKEN-3  (40 TOKEN-2 & 50 TOKEN-3 IN POOL)
...
cons = [
    ...
    # Constant sum pool
    # cp.sum(new_reserves[3]) >= cp.sum(reserves[3]),
    # new_reserves[3] >= 0,
...
pool_names = ["UNIV2 0/1", "UNIV2 1/2", "UNIV2 2/3", "UNIV2 3/2"]
